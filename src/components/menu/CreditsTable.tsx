...
const data: creditsType[] = [
    ...
    { id: 2, key: "characters-pack", author: "Kenney", title: "Tiny Dungeon", for: "Enemies and Playable Character Sprites (male and female)", link: "https://www.kenney.nl/assets/tiny-dungeon", licence: "CC0", changes: "Color of Player and Enemies was slightly modified and the original sprite (turned right) from pack is used to create other character poses (left, top, bottom, and dead)." },
